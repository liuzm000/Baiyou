...
public class HttpDownloadAsyncTask extends AsyncTask<String, Integer, String> {
	...
	protected String doInBackground(String... params) {
		logInfo(tag, "doInBackground time:"+System.currentTimeMillis());
		...
		try {
			...
			if (code == HttpURLConnection.HTTP_OK) {
				...
				logInfo(tag, "absUrl:" + absUrl.toString());
				...
				logInfo(tag, "contentType:" + contentType);
				logInfo(tag, "filename:" + filename);
				...
				logInfo(tag, "fileSize:" + Formatter.formatFileSize(context, fileSize));
			...
			// alreadyDownloadSize
			logInfo(tag, "ArrayIndexOutOfBoundsException:" + ao.getMessage());
			logInfo(tag, "alreadyDownloadSize:" + alreadyDownloadSize);
			return null;
	...
	protected void onPreExecute() {
		super.onPreExecute();
		logInfo(tag, "onPreExecute time:"+System.currentTimeMillis());
	}
	...
	private boolean isMemoryEnough(int fileSize) {
		...
		am.getMemoryInfo(mi);
		logInfo(tag, " 磁盘可以空间  " + mi.availMem);
	...
	public HttpDownloadAsyncTask(CallBack callBack, Context context,
		...
		logInfo(tag, "HttpDownloadAsyncTask time:"+System.currentTimeMillis());
	}
